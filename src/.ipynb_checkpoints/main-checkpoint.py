...
movies_countries = pd.merge(movies_table, countries_table, on='movie', how='left')

movies_countries=movies_countries=pd.merge(movies_countries,countries_table, left_on="cites", right_on="movie",how="left")

movies_countries.rename(columns={"movie_x":"movie","movie_y":"cited_movies","country_x":"movie_country","country_y":"cited_movie_country"})
print(movies_countries.head(5))